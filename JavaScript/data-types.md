...
* 메모리에 값을 저장하기 위해 확보해야 할 메모리 공간의 크기를 결정해야한다.
* 데이터 타입에 따라 몇 바이트를 읽어들일 지 결정해야한다.
* 값을 어떻게 해석해야하는 지 결정하기 위해 필요하다.

&nbsp;  

### 9.1. 데이터 타입에 의한 메모리 공간의 확보와 참조

값은 메모리에 저장하고 참조할 수 있어야한다. 메모리에 값을 저장하기 위해서는 먼저 확보해야 할 메모리 공간의 크기를 결정해야한다.
